(function (global, factory) {
    ...
    SuperCluster.prototype = {
        ...
        _cluster: function (points, zoom) {
            ...
            for (var i = 0; i < points.length; i++) {
                ...
                var firstX = false;//p.y
                var firstY = false;//p.x
    ...
    function createCluster(x, y, id, numPoints, properties, firstX, firstY) {
        return {
    ...
    function getClusterProperties(cluster) {
        ...
        return extend(extend({}, cluster.properties), {
            ...
            firstX: yLat(cluster.firstX ? cluster.firstX : cluster.y),
            firstY: xLng(cluster.firstY ? cluster.firstY : cluster.x),
            point_count: count,
