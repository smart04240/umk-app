...
import {getDaysAmountInMonth, getFullDateISO, isDate, now_month, now_year} from "../../../helpers/date";
...
const CALENDAR_WIDTH = Layout.width - Layout.calendarPickerPadding * 2;
        ...
        <View style={[
            ...
            <View style={[
                ...
                <View style={styles.days}>
                    {days_keys && !!days_keys.length && days_keys.map(day => (
                        <Text
                            key={day}
                            style={[
                                styles.day,
                ...
                <View style={styles.numbers}>
                    {numbers && !!numbers.length && numbers.map(({date_iso, date}, index) => (
                        <TouchableOpacity
                            key={date_iso}
                            style={[
                                styles.number_wrap,
