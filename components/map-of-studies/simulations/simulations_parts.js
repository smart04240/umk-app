...
export const getCompletionYear = year => ({
    ...
    value: ["Z", "A", "S"],
    complex_text: `#CompletingYearTextPart1 ${yearToRomanNumeral(year)} #CompletingYearTextPart2 ${yearToRomanNumeral(year + 1)}`,
});
...
export const getConditionalCompletionYear = year => ({
    complex_name: `#ConditionalCompletingYear ${yearToRomanNumeral(year)}`,
    value: "W",
...
export const getFailureCondition = year => ({
    ...
    value: "T",
    complex_text: `#FailureOfTheConditionOrYearText ${yearToRomanNumeral(year)}!`
});
