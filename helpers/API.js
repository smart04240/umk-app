...
// export const baseURL = 'https://c60e8407981b.ngrok.io';
...
API.events = {
    all: () => API.get('/calendar_events/for_student'),
...
API.ranking = {
    All: () => API.get('students/ranking'),
    ByFilter: params => API.get('students/getRankingByFilter', {params})
}
